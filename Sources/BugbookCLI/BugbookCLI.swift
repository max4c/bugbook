...
struct Bugbook: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [Page.self, Block.self, Backlinks.self, Skill.self, Board.self, DB.self, QueryCmd.self, Get.self, Create.self, Update.self, Delete.self, Batch.self, Agent.self, Search.self, Install.self]
    )
