...
bugbook page format "Bugbook Strategy" --style commonmark --dry-run --output summary --report
bugbook page format "Bugbook Strategy" --style commonmark --dry-run --fail-on-warnings
...
bugbook db list
bugbook db move "Agent Tickets" --page "Agent Tickets" --dry-run
bugbook db move "Agent Tickets" --page "Agent Tickets"
